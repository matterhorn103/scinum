...
Documentation will be available on [docs.rs](https://docs.rs) after the initial 0.1 release.
Until then, documentation can of course be prepared from the source code using `rustdoc`.
